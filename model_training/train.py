...
data.test_X, data.test_y, data.test_sw, data.test_groups] = model_functions.prepare_model_splits_logo(data.train_df, data.select_features, sample_weights_col  = 'clean_scaling', group_col = 'Last_Season')
